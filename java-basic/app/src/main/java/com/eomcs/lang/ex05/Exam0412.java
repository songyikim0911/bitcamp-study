...
public class Exam0412 {
  public static void main(String[] args) {
    ...
    //     10000000 00000000 00000000 00000001 -->2칸떙김
    //     11000000 00000000 00000000 00000000 --> 3칸 땡김
    System.out.println(3 << 33); // 6
    System.out.print(3 << 32);System.out.println("<오른쪽1칸,3"); //33에서 오른쪽으로 1칸 --> 3
    System.out.print(3 << 31);System.out.println("<오른쪽2칸,-무한");//33에서 오른쪽으로 두칸 땡김 --> -1111111 11111111 11111111 11111110
    System.out.print(3 << 30);System.out.println("<오른쪽3칸,-무한"); //33에서 오른쪽으로 세칸 땡김--> - 1000000 00000000 00000000 00000000
