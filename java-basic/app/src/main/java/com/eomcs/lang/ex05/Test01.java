...
public class Test01 {
  public static void main(String[] args) {
    ...
    final int LANG_C      = 0b10000000;//16진수로 0X80
    final int LANG_CPP    = 0b01000000;//16진수로 0X40
...
/*
    lang2 |= 0x80;//--> lang2 = lang2 | 0x80; // c = true
    lang2 |= 0x20; /* java = true 할당 연산자 중 하나, 기존 변수 값을 가져와 이 값과 or 계산 후 , 다시
                    변수 lang2에 이 값을 저장하는 것임. 
